...
import com.shopping.list.RecipeAdapterView;
import com.shopping.list.RecipeItem;
...
public class RecipeListFragment extends Fragment {
    ...
    private RecyclerView recipe_recycler_view;//Recycle view for card view

    private RecyclerView.Adapter adapter;
    private RecyclerView.Adapter recipeAdapter;//Adapter for card view
